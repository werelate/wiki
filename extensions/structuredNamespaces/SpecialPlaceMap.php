...
class SpecialPlaceMap {
	public static function getMapScripts($size, $mapData) {
		...
		return
			...
			"var defined_maps_api_key='$wgGoogleMapKey';".
			...
			"      script.async = true;".
			"      script.src = '//maps.googleapis.com/maps/api/js?key=' + defined_maps_api_key + String.fromCharCode(38) + 'loading=async' + String.fromCharCode(38) + 'callback=showPlaceMap';".
